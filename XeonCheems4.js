...
await XeonBotInc.sendMessage(from, {  text: msg , footer: `⚠️𝗦𝗔𝗖𝗛𝗜𝗧𝗛 𝗠𝗗⚠️ ` , buttons: buttons , headerType: 4} , { quoted: m } )  
...
*┃BOT NAME : ⚠️𝗦𝗔𝗖𝗛𝗜𝗧𝗛 𝗠𝗗⚠️ 

┗━━━━━━━━━❊`,
footer: `⚠️𝗦𝗔𝗖𝗛𝗜𝗧𝗛 𝗠𝗗⚠️ `,
buttons: buttons,
headerType: 4,
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
...
case 'ytdoc': {	    
    ...
    const auddown = await XeonBotInc.sendMessage(from , { text: '📥 ඔබ ඉල්ලු ගිතය ඩවුන්ලොඩ කරමින් ඇත...' }, { quoted: m } )
    await XeonBotInc.sendMessage(from, { delete: auddown.key })
    const audup = await XeonBotInc.sendMessage(from , { text: '📤 ගිතය අප්ලොඩ් කරමින් ඇත...' }, { quoted: m } )
...
break
            case 'ytmp4': {
                                ...
                                const viddown = await XeonBotInc.sendMessage(from , { text: '📥 විඩියොව ඩවුන්ලොඩ් කරමින් ඇත..' }, { quoted: m } )
                                await XeonBotInc.sendMessage(from, { delete: viddown.key })
                                const vidup = await XeonBotInc.sendMessage(from , { text: '📤 අප්ලොඩ් කරමින ඇත....' }, { quoted: m } )
